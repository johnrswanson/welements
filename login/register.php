...
if (isset($_POST['submit'])) 
		...
		$check = mysql_query("SELECT * FROM users WHERE email = '$usercheck'") 
		or die(mysql_error());
...
mysql_query("INSERT INTO users (ID, email, password, shortname) VALUES ('', '$email', '$pass', '$shortname' ) ") or die(mysql_error());
